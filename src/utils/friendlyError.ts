...
const MAP: Array<{ test: RegExp; message: string }> = [
  ...
  { test: /کد تأیید اشتباه|منقضی شده/i, message: "کد درست نیست یا وقتش تمام شده. دوباره کد بگیر." },
  { test: /شماره موبایل نامعتبر/i, message: "شماره رو با ۰۹ شروع کن و ۱۱ رقم بنویس." },
  { test: /فروشگاه.*ثبت|complete-profile/i, message: "اول فروشگاهت رو کامل کن، بعد کالا بگذار." },
  { test: /تصویر|image|upload/i, message: "با عکس مشکل پیش اومد. یه عکس دیگه امتحان کن." },
  { test: /500|سرور|internal/i, message: "الان یه مشکل موقتی هست. کمی بعد دوباره امتحان کن." },
];
