...
export default function Messages() {
  ...
  const handleDelete = useCallback((id: string) => {
    ...
    // TODO: صدا زدن API برای حذف گفتگو در بک‌اند
  }, [setConvs]);
        ...
        <div className="max-w-2xl mx-auto flex flex-col gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="جستجوی فروشگاه یا پیام..."
      ...
      <main className="px-4 py-5 max-w-2xl mx-auto">
        {loading ? (
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">خطا در دریافت پیام‌ها</h3>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 className="text-lg font-black text-gray-900 dark:text-white mb-2">
              {query ? "نتیجه‌ای یافت نشد" : "هیچ گفتگویی ندارید"}
            </h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 max-w-xs leading-relaxed">
              {query 
                ? "با این کلمه جستجو، گفتگویی پیدا نکردیم. لطفا عبارت دیگری را امتحان کنید." 
                : "شما هنوز با هیچ فروشگاهی چت نکرده‌اید. برای شروع، به صفحه محصولات بروید."}
            </p>
          </motion.div>
