...
export class HomeErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center bg-gradient-to-b from-rose-50 to-white dark:from-gray-900 dark:to-gray-950">
          ...
          <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-2">اوه! مشکلی پیش آمد</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-8 max-w-xs">یک خطای غیرمنتظره رخ داده است. لطفاً صفحه را رفرش کنید.</p>
          <button 
