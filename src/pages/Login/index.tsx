...
import { Loader2, LockKeyholeOpen, ShieldCheck, Lock } from "lucide-react";
      ...
      <main className="flex-1 flex flex-col justify-center px-8 w-full z-10 py-10">
        ...
        <div className="mb-10 text-center">
          <motion.div 
            ...
            animate={{ scale: 1, rotate: state.step === "phone" ? 0 : 10 }} 
          ...
          >
            {state.step === "phone" ? "خوش آمدید!" : "تایید شماره"}
          </motion.h2>
