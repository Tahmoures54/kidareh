    ...
    <div className="bg-white dark:bg-gray-900 rounded-[2rem] shadow-2xl shadow-emerald-500/10 border border-gray-100 dark:border-gray-800 overflow-hidden relative">
      ...
      <div className="bg-emerald-500 text-white p-8 text-center relative overflow-hidden">
        ...
        <h2 className="text-2xl font-black mb-1 flex items-center justify-center gap-2 drop-shadow-sm">
          پرداخت شد 🎉 <Sparkles className="w-5 h-5 text-emerald-200" />
        </h2>
        <p className="text-emerald-100 text-xs font-medium">همه‌چیز اوکی شد.</p>
      </div>
      ...
      <div className="p-6 pt-2 pb-8">
        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-4 mb-6 space-y-4">
          <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 flex items-center gap-1.5 uppercase tracking-wider">
            <Receipt className="w-3.5 h-3.5" /> جزئیات
          </p>
          <div className="flex items-center justify-between text-sm">
            <span className="text-gray-500 dark:text-gray-400 font-bold">وضعیت:</span>
            <span className="bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 font-black px-2.5 py-1 rounded-lg text-xs">تأیید شد</span>
          </div>
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <button type="button" onClick={onCopy} className="w-8 h-8 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-xl hover:bg-emerald-50 dark:hover:bg-emerald-500/10 active:scale-90 transition-all text-gray-600 dark:text-gray-300" aria-label="کپی کد">
        ...
        <div className="flex gap-3">
          <button type="button" onClick={onHome} className="flex-[1] h-14 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-2xl font-black text-sm flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-700 active:scale-[0.98] transition-all" aria-label="خانه">
            <Home className="w-5 h-5" />
          </button>
          <button type="button" onClick={onSeller} className="flex-[3] h-14 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-2xl font-black text-sm flex items-center justify-center gap-2 shadow-xl shadow-gray-900/20 dark:shadow-white/10 active:scale-[0.98] transition-all">
            برو به پنل <ArrowRight className="w-4 h-4" />
          </button>
        </div>
      </div>
    </div>
