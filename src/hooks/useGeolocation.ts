...
import { findIranCity, findNearestIranCity } from "@data/processed/iranCities";
...
export function useGeolocation(
  ...
  // Fallback City Info
  const fallbackMatched = findIranCity(fallbackCity);
  ...
  const requestGeolocation = useCallback(() => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        const nearest = findNearestIranCity(latitude, longitude);
