  ...
  return (
    <div className="fixed bottom-16 inset-x-0 bg-[var(--bg-secondary)]/85 backdrop-blur-2xl border-t border-[var(--border-light)] p-4 pb-[max(16px,env(safe-area-inset-bottom))] z-[70] lg:bottom-0">
      <div className="max-w-md mx-auto flex gap-3">
        ...
        <motion.button whileTap={{ scale: 0.9 }} onClick={onMessageClick} aria-label="پیام به فروشگاه" className="w-14 h-14 bg-[var(--brand-primary)]/10 text-[var(--brand-primary)] rounded-2xl flex items-center justify-center shrink-0 border border-[var(--brand-primary)]/20">
